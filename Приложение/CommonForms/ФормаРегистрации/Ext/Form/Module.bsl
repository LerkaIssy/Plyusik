...
Процедура НачислитьНачальныйБюджетСтудента(ИгрокСсылка)
	 ...
	 СтартИгры.НачальныйРейтинг = 10;
	 СтартИгры.Записать(РежимЗаписиДокумента.Проведение,РежимПроведенияДокумента.Неоперативный);
